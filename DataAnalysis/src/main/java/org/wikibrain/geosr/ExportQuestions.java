...
//
//
//    public ExportQuestions(Env env) throws IOException {
//        this.env = env;
//        buildIdsStringMap();
//        readInIdToScaleInfo();
//        readNeighbors();
...
//        int rank = 1;
//        for (String line : FileUtils.readLines(new File("survey_old/dat/PageHitListFullEnglish.txt"))) {
...
//        File file = new File("survey_old/dat/IDsToTitles.txt");
...
//        Scanner scanner= new Scanner(new File("survey_old/dat/geometryToScale.txt"));
...
//        Scanner scan = new Scanner(new File("survey_old/dat/citiesToNeighbors4.txt"));
...
//        String[] files = {"survey_old/dat/cities1000.txt","survey_old/dat/cities1000.old.txt"};
...
//        Scanner scan = new Scanner(new File("survey_old/dat/admin1CodesASCII.txt"));
//        while (scan.hasNextLine()) {
//            String line = scan.nextLine();
//            String[] array = line.split("\t");
...
//        ExportQuestions enhancer = new ExportQuestions(env);
//        enhancer.enhance(
